...
suite('Unit Tests', () => {
  ...
  suite('Translate to American English', function(){
    ...
    test("Translate Tea time is usually around 4 or 4.30. to American English", function(done){
      ...
      var expected = '<span class="highlight">4:30</span>.';
      assert.include(translator.toAmerican(input), expected, "American English should read: " + expected);
      done();
    });
  });
  ...
  suite('Check for highlight', function(){
    ...
    test('Highlight translation in Mangoes are my favorite fruit.', function(done){
      var input = 'Mangoes are my favorite fruit.';
      var expected = '<span class="highlight">favourite</span>';
      assert.include(translator.toBritish(input), expected, "favourite should be highlighted");
      done();
    });
    ...
    test('Highlight translation in I ate yogurt for breakfast.', function(done){
      var input = 'I ate yogurt for breakfast.';
      var expected = '<span class="highlight">yoghurt</span>';
      assert.include(translator.toBritish(input), expected, "yoghurt should be highlighted");
      done();
    });
    ...
    test('Highlight translation in We watched the footie match for a while.', function(done){
      var input = 'We watched the footie match for a while.';
      var expected = '<span class="highlight">soccer</span>';
      assert.include(translator.toAmerican(input), expected, "soccer should be highlighted");
      done();
    });
    ...
    test('Highlight translation in Paracetamol takes up to an hour to work.', function(done){
      var input = 'Paracetamol takes up to an hour to work.';
      var expected = '<span class="highlight">Tylenol</span>';
      assert.include(translator.toAmerican(input), expected, "Tylenol should be highlighted");
      done();
    });
  });
});